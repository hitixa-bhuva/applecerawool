<?php
$Title = "Contact Us | Apple Cerawool Industrial Insulation & Refractory Solutions";
$MetaDescription = "Get in touch with Apple Cerawool for inquiries, support, and product information. Our team provides expert guidance on industrial insulation, ceramic fiber, and refractory solutions worldwide.";
$MetaKeywords = "contact Apple Cerawool, industrial insulation inquiries, ceramic fiber support, refractory solutions contact, Apple Cerawool customer service";
?>
    ...
    <div class="col-md-12">
      <div class="rs-contact-btn">
        <button type="submit" class="rs-btn has-theme-orange">Send Message</button>
                            ...
                            <!-- Toast container -->
                            <!-- Toast container at top, below navbar -->
<div class="position-fixed top-0 end-0 translate-middle-x " style="z-index: 1080; margin-top: 120px;">
  <div id="email-toast" class="toast align-items-center text-bg-success border-0" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="d-flex">
      ...
      <button type="button" class="btn-close btn-close-white me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>
        ...
        <section class="rs-contact-area pb-4 rs-contact-nine">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <iframe 
                              src="https://www.google.com/maps?q=14+Paiki+3,+Adalshar+Road,+Lakhatar,+Surendranagar,+Gujarat+363775&output=embed" 
                              width="100%" 
                              height="600" 
                              style="border:0;" 
                              allowfullscreen="" 
