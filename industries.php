<?php
$Title = "Industries Served | Apple Cerawool Industrial Insulation Solutions";
$MetaDescription = "Apple Cerawool provides industrial insulation and refractory solutions across multiple industries including steel, cement, glass, power, and chemical sectors. High-performance ceramic fiber products for every application.";
$MetaKeywords = "industries served, Apple Cerawool, industrial insulation, refractory solutions, steel industry insulation, cement industry insulation, glass industry insulation, ceramic fiber applications";
?>
                    ...
                    <div class="col-xxl-6 col-xl-8 col-lg-8">
                        <div class="rs-breadcrumb-content-wrapper">
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Industries</h1>
                            </div>
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-wrapper-left">
                              ...
                              Industries We Serve
                                    ...
                                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">Reliable Solutions for Every Industry</h2>
                                </div>
                                <div class="rs-about-thumb has-large">
                                    ...
                                    <div class="rs-about-counter-wrapper gsap-move up-100 start-70">
                                        <div class="rs-counter-bg-thumb" data-background="assets/images/shape/star-shape.png">
                                        </div>
                            ...
                            <div class="rs-about-wrapper-right">
                                ...
                                <div class="rs-about-content-wrapper">
                                        ...
                                        <div class="tab-content rs-about-tab-anim" id="pills-tabContent">
                                            <div class="tab-pane fade show active" id="pills-item-one" role="tabpanel" aria-labelledby="pills-item-one-tab" tabindex="0">
                                                <div class="rs-about-tab-content">
                                                    <p>Apple Cera Wool supports industries like steel, aluminum, cement, power, and glass with durable insulation and refractory solutions. Our products are built to handle extreme heat, save energy, and improve safety.</p>
                                                    <p>We focus on reliability and custom-fit solutions for every sector. From boosting furnace efficiency to protecting equipment, we help industries run smoothly and last longer.</p>
                                                    <div class="rs-about-feature-list">
                                                        <div class="rs-list-item">
                                                            <ul>
                                                                <li>
                                                                    <i class="fa-regular fa-check"></i>
                                                                    Tailored solutions for high-demand sectors
                                                                </li>
                                                                <li>
                                                                    <i class="fa-regular fa-check"></i>
                                    ...
                                    <div class="rs-about-btn">
                                        <a class="rs-btn has-theme-orange has-icon has-bg" href="about-us">Explore More
                                            <span class="icon-box">
                    ...
                    <div class="col-xl-7 col-lg-7">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="11" height="15" viewBox="0 0 11 15" fill="none">
                         ...
                         Industry Showcase
                            ...
                            <p>Each industry gets a dedicated section with image, overview, applications, and suggested products.</p>
                        </div>
                    </div>
                </div>
                <div class="row g-5 process-counts">
                        ...
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item">
                                ...
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title"> Steel</h5>
                                    <p class="descrip"> Solutions for blast furnaces, ladles, tundishes, and continuous casting.</p>
                                    <ul class="px-3">
                                        <li>High refractory bricks</li>
                                        <li>monolithics</li>
                                        <li>coatings</li>
                                    </ul>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item">
                                <div class="rs-services-thumb">
                                    <a href="services-details.html"> <img src="assets/images/services/services-thumb-09.png" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title">Aluminum </h5>
                                    <p class="descrip">Tailored products for smelting, refining, and casting.</p>
                                    <ul>
                                        <li> Low-iron refractorie</li>
                                        <li>mixes</li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item">
                                <div class="rs-services-thumb">
                                    <a href="services-details.html"> <img src="assets/images/services/services-thumb-14.png" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title">Glass</h5>
                                    <p class="descrip">Heat-resistant materials for glass furnaces and regenerators.</p>
                                    <ul>
                                        <li>Insulating bricks</li>
                                        <li>high-alumina refractories</li>
                                        <li>specialty mixes</li>
                                    </ul>
                                    <div class="rs-services-number"></div>
                                    <!-- <div class="rs-services-btn-wrapper">
                                        <div class="rs-services-text-btn underline">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item">
                                <div class="rs-services-thumb">
                                    <a href="services-details.html"> <img src="assets/images/services/services-thumb-15.png" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title">Ceramics</h5>
                                    <p class="descrip">Advanced linings and kiln furniture for ceramics & sanitaryware</p>
                                    <ul>
                                        <li>Coatings</li>
                                        <li>kiln furniture</li>
                                        <li> refractory shapes</li>
                                    </ul>
                                    <div class="rs-services-number"></div>
                                    <!-- <div class="rs-services-btn-wrapper">
                                        <div class="rs-services-text-btn underline">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item">
                                <div class="rs-services-thumb">
                                    <a href="services-details.html"> <img src="assets/images/services/services-thumb-16.png" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title">Power</h5>
                                    <p class="descrip"> High-performance refractories for boilers, and power plants.</p>
                                    <ul>
                                        <li>Castables</li>
                                        <li>coatings</li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item">
                                <div class="rs-services-thumb">
                                    <a href="services-details.html"> <img src="assets/images/services/services-thumb-31.png" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title">Cement</h5>
                                    <p class="descrip">Proven refractory solutions for rotary kilns and clinker production</p>
                                    <ul>
                                        <li>High refractory bricks</li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item">
                                <div class="rs-services-thumb">
                                    <a href="services-details.html"> <img src="assets/images/services/services-thumb-32.png" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title">Chemical</h5>
                                    <p class="descrip">Corrosion & heat-resistant materials for the chemical industry.</p>
                                    <ul>
                                        <li>Acid-resistant bricks</li>
                                        <li> specialty linings</li>
                                        <li>binders</li>
                                    </ul>
                                    <div class="rs-services-number"></div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="rs-services-wrapper">
                            <div class="rs-services-item">
                                <div class="rs-services-thumb">
                                    <a href="services-details.html"> <img src="assets/images/services/services-thumb-33.png" alt="image"></a>
                                </div>
                                <div class="rs-services-content">
                                    <h5 class="rs-services-title">Fire Protection</h5>
                                    <p class="descrip">Specialty materials for fire safety and passive protection. <br> Fire doors, safes, insulation panels </p>
                                    <ul>
                                        <li>Fireproof coatings</li>
