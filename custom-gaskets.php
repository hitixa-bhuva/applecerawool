<?php
$Title = "Custom Gaskets | Apple Cerawool Industrial Insulation Solutions";
$MetaDescription = "Apple Cerawool Custom Gaskets are precision-engineered for industrial insulation and refractory applications. Durable, high-performance, and tailored to your specific requirements.";
$MetaKeywords = "custom gaskets, Apple Cerawool gaskets, industrial insulation gaskets, refractory solutions, precision gaskets, high-performance gaskets";
?>
...
<a href="tel:918000002234">+91 80000 02234</a>
    ...
    <main>
        ...
        <section class="rs-breadcrumb-area rs-breadcrumb-one p-relative">
            <div class="rs-breadcrumb-bg" data-background="assets/images/history/history-thumb-05.png"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xxl-6 col-xl-8 col-lg-8">
                        <div class="rs-breadcrumb-content-wrapper">
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Custom Gaskets</h1>
                            </div>
                            <div class="rs-breadcrumb-menu">
                                <nav>
                                    <ul>
                                        <li><span><a href="home">Industrie</a></span></li>
                                        <li><span>Custom Gaskets</span></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-thumb-wrapper">
                                ...
                                <div class="rs-about-thumb">
                                    <img src="assets/images/service/Custom-Gaskets/Custom-Gaskets-1.webp" alt="image">
                                </div>
                            ...
                            <div class="rs-about-content-wrapper">
                              ...
                              Custom Gaskets
                                    ...
                                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">Sealing solutions  <span
                                 class="rs-theme-orange">for extreme </span>environments</h2>
                                    <p class="descrip">High-performance gaskets engineered to withstand temperature, chemical, and pressure challenges.</p>
                                </div>
                                    ...
                                    <div class="tab-content rs-about-tab-anim" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-item-one" role="tabpanel" aria-labelledby="pills-item-one-tab" tabindex="0">
                                            <div class="rs-about-tab-content">
                                                <p> Apple Cera Wool provides precision-made custom gaskets that ensure reliable sealing in harsh industrial conditions. Designed for durability and efficiency, our gaskets minimize leakage, improve safety, and extend equipment life.</p>
                    ...
                    <div class="col-12">
                        <div class="rs-about-wrapper">
                            ...
                            <div class="rs-about-thumb-wrapper">
                                ...
                                <div class="rs-about-thumb">
                                    <img src="assets/images/service/Custom-Gaskets/Custom-Gaskets-2.webp" alt="image">
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-5">
                        <div class="rs-about-thumb-wrapper">
                            ...
                            <div class="rs-about-thumb img-one">
                                <img src="assets/images/service/Custom-Gaskets/Custom-Gaskets-3.jpg" alt="image">
                            </div>
                            <div class="rs-about-thumb img-two">
                                <img src="assets/images/service/Custom-Gaskets/Custom-Gaskets-4.jpg" alt="image">
                            </div>
                        </div>
                    </div>
