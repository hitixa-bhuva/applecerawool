<?php
$Title = "Ceramic Papers & Felts | Apple Cerawool Industrial Insulation Solutions";
$MetaDescription = "Apple Cerawool Ceramic Papers & Felts provide superior thermal insulation for industrial and refractory applications. Durable, flexible, and high-performance ceramic fiber solutions.";
$MetaKeywords = "ceramic papers, ceramic felts, Apple Cerawool, industrial insulation, refractory insulation, high-temperature insulation, ceramic fiber products";
?>
...
<a href="tel:918000002234">+91 80000 02234</a>
    ...
    <main>
        ...
        <section class="rs-breadcrumb-area rs-breadcrumb-one p-relative">
            <div class="rs-breadcrumb-bg" data-background="assets/images/history/history-thumb-01.png"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xxl-6 col-xl-8 col-lg-8">
                        <div class="rs-breadcrumb-content-wrapper">
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Ceramic Papers & Felts</h1>
                            </div>
                            <div class="rs-breadcrumb-menu">
                                <nav>
                                    <ul>
                                        <li><span><a href="home">Industrie</a></span></li>
                                        <li><span>Ceramic Papers & Felts</span></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-thumb-wrapper">
                                ...
                                <div class="rs-about-thumb">
                                    <img src="assets/images/product/CeramicFiberPaper.jpg" alt="image">
                                </div>
                            </div>
                            <div class="rs-about-content-wrapper">
                                <div class="rs-section-title-wrapper">
                                    <span class="rs-section-subtitle has-stroke justify-content-start">
                             Ceramic Papers & Felts
                           </span>
                                    <h2 class="rs-section-title rs-split-text-enable split-in-fade"> Thin, flexible insulation materials</h2>
                                    <p class="descrip">Lightweight and flexible for precision insulation.</p>
                                </div>
                                    ...
                                    <div class="tab-content rs-about-tab-anim" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-item-one" role="tabpanel" aria-labelledby="pills-item-one-tab" tabindex="0">
                                            <div class="rs-about-tab-content">
                                                <p>  Ceramic fiber papers and felts are thin, lightweight, and flexible insulation materials designed for sealing, gasketing, and wrapping. </p>
                                                <ul>
                                                    <li>ceramic paper</li>
                                                    <li>ceramic felt</li>
                                                    <li>thin insulation</li>
                                                    <li>gasketing</li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="rs-why-choose-content-wrapper">
                           ...
                           Key Features
                                ...
                                <h2 class="rs-section-title has-theme-blue rs-split-text-enable split-in-fade">Flexibility Meets Performance</h2>
                                <p>Ceramic papers and felts combine lightweight design with high-temperature resistance, making them ideal for precision applications that demand flexibility and strength.</p>
                            </div>
                            <div class="rs-why-choose-item-wrapper">
                                <div class="rs-why-choose-item">
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title"> Thin and flexible design</h5>
                                    </div>
                                </div>
                                <div class="rs-why-choose-item">
                                    <div class="rs-why-choose-icon has-white">
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title">Excellent thermal stability</h5>
                                    </div>
                                </div>
                                <div class="rs-why-choose-item">
                                    <div class="rs-why-choose-icon has-white">
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title">Low thermal conductivity</h5>
                                    </div>
                                </div>
                                <div class="rs-why-choose-item">
                                    <div class="rs-why-choose-icon has-white">
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title">Easy to cut and shape</h5>
                                    </div>
                                </div>
                                <div class="rs-why-choose-item">
                                    <div class="rs-why-choose-icon has-white">
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title">Resistant to chemicals</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-why-choose-thumb-wrapper">
                            <div class="rs-why-choose-thumb">
                                <img src="assets/images/product/CeramicFiberPaper/Ceramic-Fiber-Paper-2.jpg" alt="image">
                            </div>
                            <div class="rs-why-choose-small-thumb">
                                <img src="assets/images/product/CeramicFiberPaper/Ceramic-Fiber-Paper-4.jpg" alt="image">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-content-wrapper">
                              ...
                              Applications & Benefits
                                    ...
                                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">Reliable Insulation for Specialized Uses</h2>
                                    <p>Designed for sealing, wrapping, and protection, ceramic papers and felts are widely used where lightweight yet durable insulation is essential.</p>
                                </div>
                                <div class="rs-aobut-tab-content-wrapper">
                                    <div class="tab-content rs-about-tab-anim" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-item-one" role="tabpanel" aria-labelledby="pills-item-one-tab" tabindex="0">
                            ...
                            <div class="rs-about-thumb-wrapper">
                                ...
                                <div class="rs-about-thumb">
                                    <img src="assets/images/product/CeramicFiberPaper/Ceramic-Fiber-Paper-5.jpg" alt="image">
                                </div>
                            </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="sub-products-details">
                                    <span class="sub-products-spec-highlight">100</span> / 
                                    <span class="sub-products-spec-highlight">160</span> kg/m³
                                </td>
                            </tr>
                            <tr>
                                <td class="sub-products-parameter">
                                ...
                                <td class="sub-products-details">
                                    <span class="sub-products-spec-highlight">1 – 10mm</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="sub-products-parameter">
                                ...
                                <td class="sub-products-details">
                                    Up to <span class="sub-products-spec-highlight"> Up to 1260°C</span>
                            ...
                            <tr>
                                ...
                                <td class="sub-products-details">
                                    ...
                                    <span class="sub-products-spec-highlight">Rolls  </span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
