<?php
$Title = "Services | Apple Cerawool Industrial Insulation & Refractory Solutions";
$MetaDescription = "Apple Cerawool offers a wide range of services including custom gaskets, furnace doors, coatings, machined parts, and expert project management for industrial insulation and refractory solutions.";
$MetaKeywords = "Apple Cerawool services, industrial insulation services, refractory solutions services, custom gaskets, furnace doors, coatings, machined parts, project management";
?>
...
<a href="tel:918000002234">+91 80000 02234</a>
    ...
    <main>
        ...
        <!-- breadcrumb area end -->
                ...
                <!-- about area start -->
        <section class="rs-about-area section-space rs-about-eight has-theme-green">
            <div class="container">
                <div class="row g-5">
                    <div class="col-xl-6 col-lg-5">
                        <div class="rs-about-thumb-wrapper">
                            ...
                            <div class="rs-about-thumb img-one">
                                <img src="assets/images/product/CeramicFiberRope/Ceramic-Fiber-Rope-3.webp" alt="image">
                            </div>
                            <div class="rs-about-thumb img-two">
                                <img src="assets/images/product/CeramicFiberBoard/Ceramic-Fiber-Board-4.jpg" alt="image">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-content-wrapper">
                              ...
                              Smart Thermal Solutions
                                    ...
                                    <h2 class="rs-section-title has-theme-green rs-split-text-enable split-in-fade">Our Innovative Solutions & Services</h2>
                                    <p class="descrip">Apple Cera Wool provides smart thermal solutions designed to meet the toughest industrial demands. Our services and products are engineered to maximize efficiency, ensure safety, and extend the life of equipment across multiple industries.</p>
                                </div>
        ...
        <!-- about area end -->
         ...
         <!-- services area start -->
        <section class="rs-services-area section-space-top rs-services-six">
            <div class="container has-large">
                ...
                <div class="row  g-5 section-title-space align-items-center">
                    <div class="col-xl-6 col-lg-6 col-md-7">
                        <div class="rs-section-title-wrapper">
                            <h2 class="rs-section-title has-theme-light-blue rs-split-text-enable split-in-fade">Smart refractory solutions built for the toughest industrial needs </h2>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-5">
                        <div class="rs-services-btn">
                            <a class="rs-btn has-theme-light-blue has-icon has-bg" href="services">More Services
                                <span class="icon-box">
                           <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                              <path
                                 d="M31.71,15.29l-10-10L20.29,6.71,28.59,15H0v2H28.59l-8.29,8.29,1.41,1.41,10-10A1,1,0,0,0,31.71,15.29Z">
                ...
                <div class="row g-5 process-counts">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="rs-services-item wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <div class="rs-services-bg-thumb" data-background="assets/images/shape/service-shape.png"></div>
                            <h4 class="rs-services-title underline has-theme-blue"><a href="services-details.html">
                                    Custom Gaskets </a></h4>
                            <p class="descrip"> Engineered for precision sealing in high-temperature environments. Protects equipment, minimizes leakage, and ensures safety.</p>
                            <div class="rs-services-icon">
                                <a class="rs-btn has-icon has-transparent-btn" href="services-details.html">
                                    <span class="icon-box">
                              <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" width="26" height="12"
                                 viewBox="0 0 26 12" fill="none">
                                 <path opacity="0.6"
                              ...
                              <svg class="icon-second" xmlns="http://www.w3.org/2000/svg" width="26" height="12"
                                 viewBox="0 0 26 12" fill="none">
                                 <path opacity="0.6"
                                    d="M25.5303 6.53033C25.8232 6.23743 25.8232 5.76256 25.5303 5.46967L20.7574 0.696697C20.4645 0.403804 19.9896 0.403804 19.6967 0.696697C19.4038 0.989591 19.4038 1.46446 19.6967 1.75736L23.9393 6L19.6967 10.2426C19.4038 10.5355 19.4038 11.0104 19.6967 11.3033C19.9896 11.5962 20.4645 11.5962 20.7574 11.3033L25.5303 6.53033ZM6.55671e-08 6.75L25 6.75L25 5.25L-6.55671e-08 5.25L6.55671e-08 6.75Z"
                                    fill="#616161"></path>
                            ...
                            <div class="rs-services-thumb">
                                <img src="assets/images/services/services-thumb-17.png" alt="image">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="rs-services-item wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                            ...
                            <h4 class="rs-services-title underline has-theme-blue"><a href="services-details.html">
                                    Furnace Doors</a></h4>
                            <p class="descrip"> Durable, insulated doors designed for energy efficiency.
 Built to withstand repeated thermal cycles and heavy use.</p>
                            <div class="rs-services-icon">
                                <a class="rs-btn has-icon has-transparent-btn" href="services-details.html">
                                    <span class="icon-box">
                              <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" width="26" height="12"
                            ...
                            <div class="rs-services-thumb">
                                <img src="assets/images/services/services-thumb-18.png" alt="image">
                            </div>
                            <div class="rs-services-number"></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="rs-services-item wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                            ...
                            <h4 class="rs-services-title underline has-theme-blue"><a href="services-details.html">
                                    Machined Parts </a></h4>
                            <p class="descrip">  High-accuracy thermal components tailored to your needs.
 Deliver consistent performance under extreme conditions.</p>
                            <div class="rs-services-icon">
                                <a class="rs-btn has-icon has-transparent-btn" href="services-details.html">
                                    <span class="icon-box">
                              <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" width="26" height="12"
                            ...
                            <div class="rs-services-thumb">
                                <img src="assets/images/services/services-thumb-19.png" alt="image">
                            </div>
                            <div class="rs-services-number"></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="rs-services-item wow fadeInUp" data-wow-delay=".9s" data-wow-duration="1s">
                            ...
                            <h4 class="rs-services-title underline has-theme-blue"><a href="services-details.html">
                                    Coatings </a></h4>
                            <p class="descrip"> We provide protective coatings that resist heat and wear, extend equipment life, and reduce costly downtime.</p>
                            <div class="rs-services-icon">
                                <a class="rs-btn has-icon has-transparent-btn" href="services-details.html">
                                    <span class="icon-box">
                              <svg class="icon-first" xmlns="http://www.w3.org/2000/svg" width="26" height="12"
                            ...
                            <div class="rs-services-thumb">
                                <img src="assets/images/services/services-thumb-20.png" alt="image">
                            </div>
                            <div class="rs-services-number"></div>
                        </div>
                    </div>
