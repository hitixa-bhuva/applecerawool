<?php
$Title = "Ceramic Modules | Apple Cerawool Industrial Insulation Solutions";
$MetaDescription = "Apple Cerawool Ceramic Modules provide high-performance industrial insulation for high-temperature applications. Durable, efficient, and ideal for refractory and thermal management solutions.";
$MetaKeywords = "ceramic modules, Apple Cerawool, industrial insulation, high-temperature insulation, refractory solutions, thermal management, ceramic fiber modules";
?>
                    ...
                    <div class="col-xxl-6 col-xl-8 col-lg-8">
                        <div class="rs-breadcrumb-content-wrapper">
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Ceramic Modules</h1>
                            </div>
                            <div class="rs-breadcrumb-menu">
                                <nav>
                                    <ul>
                                        <li><span><a href="home">Industrie</a></span></li>
                                        <li><span>Ceramic Modules</span></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-thumb-wrapper">
                                ...
                                <div class="rs-about-thumb">
                                    <img src="assets/images/product/CeramicFiberModule/Ceramic-Fiber-Module-4.jpg" alt="image">
                                </div>
                            </div>
                            <div class="rs-about-content-wrapper">
                             ...
                             Ceramic Modules
                                    ...
                                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">Pre-assembled insulation blocks for easy installation</h2>
                                    <p class="descrip">  Faster installation and superior furnace lining performance.</p>
                                </div>
                                    ...
                                    <div class="tab-content rs-about-tab-anim" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-item-one" role="tabpanel" aria-labelledby="pills-item-one-tab" tabindex="0">
                                            <div class="rs-about-tab-content">
                                                <p> Ceramic fiber modules are pre-assembled insulation blocks that simplify furnace lining installation. They reduce downtime and provide uniform insulation. These modules expand slightly at high temperatures to ensure tight joints and efficiency. </p>
                                                <ul>
                                                    <li>ceramic fiber modules</li>
                                                    <li>furnace lining</li>
                                                    <li>pre-assembled insulation</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="rs-why-choose-content-wrapper">
                           ...
                           Key Features
                                ...
                                <h2 class="rs-section-title has-theme-blue rs-split-text-enable split-in-fade">Built for Performance and Reliability</h2>
                                <p>Ceramic fiber modules are designed to deliver consistent insulation with easy handling and long-lasting durability, making them ideal for high-demand industrial operations.</p>
                            </div>
                            <div class="rs-why-choose-item-wrapper">
                                <div class="rs-why-choose-item">
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title"> Easy and fast installation</h5>
                                    </div>
                                </div>
                                <div class="rs-why-choose-item">
                                    <div class="rs-why-choose-icon has-white">
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title">Excellent thermal efficiency</h5>
                                    </div>
                                </div>
                                <div class="rs-why-choose-item">
                                    <div class="rs-why-choose-icon has-white">
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title">Vibration and thermal shock resistance</h5>
                                    </div>
                                </div>
                                <div class="rs-why-choose-item">
                                    <div class="rs-why-choose-icon has-white">
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title">Pre-assembled for hassle-free use</h5>
                                    </div>
                                </div>
                                <div class="rs-why-choose-item">
                                    <div class="rs-why-choose-icon has-white">
                                    ...
                                    <div class="rs-why-choose-content">
                                        <h5 class="rs-why-choose-title">Extended service life</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="rs-why-choose-thumb-wrapper">
                            <div class="rs-why-choose-thumb">
                                <img src="assets/images/product/CeramicFiberModule.jpg" alt="image">
                            </div>
                            <div class="rs-why-choose-small-thumb">
                                <img src="assets/images/product/CeramicFiberModule/Ceramic-Fiber-Module-2.webp" alt="image">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-content-wrapper">
                              ...
                              Applications & Benefits
                                    ...
                                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">Versatile Solutions for High-Temperature Systems</h2>
                                    <p>Trusted across multiple industries, ceramic modules ensure efficient, uniform insulation for high-performance operations.</p>
                                </div>
                                <div class="rs-aobut-tab-content-wrapper">
                                    <div class="tab-content rs-about-tab-anim" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-item-one" role="tabpanel" aria-labelledby="pills-item-one-tab" tabindex="0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="sub-products-details">
                                    <span class="sub-products-spec-highlight">160</span> / 
                                    <span class="sub-products-spec-highlight">220</span> kg/m³
                                </td>
                            </tr>
                            <tr>
                                <td class="sub-products-parameter">
                                ...
                                <td class="sub-products-details">
                                    <span class="sub-products-spec-highlight">100 – 300mm</span>
                                </td>
                            </tr>
                            <tr>
                                <td class="sub-products-parameter">
                            ...
                            <tr>
                                ...
                                <td class="sub-products-details">
                                    ...
                                    <!-- <span class="sub-products-spec-highlight">Grey</span> -->
                                </td>
                            </tr>
                            <tr>
                                <td class="sub-products-parameter">
                                ...
                                <td class="sub-products-details">
                                     <!-- <span class="sub-products-spec-highlight">Sheets  </span> / -->
                                    <span class="sub-products-spec-highlight">Modules </span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
