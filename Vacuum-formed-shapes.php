<?php
$Title = "Vacuum Formed Shapes | Apple Cerawool Industrial Insulation Solutions";
$MetaDescription = "Apple Cerawool Vacuum Formed Shapes provide precise, high-quality solutions for industrial insulation and refractory applications. Durable and efficient ceramic fiber shapes tailored for your projects.";
$MetaKeywords = "vacuum formed shapes, Apple Cerawool, industrial insulation, refractory solutions, ceramic fiber shapes, high-temperature insulation, custom insulation shapes";
?>
...
<a href="tel:918000002234">+91 80000 02234</a>
    ...
    <main>
        ...
        <section class="rs-breadcrumb-area rs-breadcrumb-one p-relative">
            <div class="rs-breadcrumb-bg" data-background="assets/images/blog/blog-post-02.png"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xxl-6 col-xl-8 col-lg-8">
                        <div class="rs-breadcrumb-content-wrapper">
                            <div class="rs-breadcrumb-title-wrapper">
                                <h1 class="rs-breadcrumb-title">Vacuum Formed Shapes</h1>
                            </div>
                            <div class="rs-breadcrumb-menu">
                                <nav>
                                    <ul>
                                        <li><span><a href="home">Industrie</a></span></li>
                                        <li><span>Vacuum Formed Shapes</span></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-thumb-wrapper">
                                ...
                                <div class="rs-about-thumb">
                                    <img src="assets/images/service/Vacuum-formed/Vacuum-formed-shapes-3.jpg" alt="image">
                                </div>
                            </div>
                            <div class="rs-about-content-wrapper">
                              ...
                              Vacuum-Formed Shapes
                                    ...
                                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">Precision-engineered <span
                                 class="rs-theme-orange">insulation </span> <br> parts for complex requirements</h2>
                                    <p class="descrip">Lightweight, durable, and made to exact specifications.</p>
                                </div>
                                    ...
                                    <div class="tab-content rs-about-tab-anim" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-item-one" role="tabpanel" aria-labelledby="pills-item-one-tab" tabindex="0">
                                            <div class="rs-about-tab-content">
                                                <p>  Apple Cera Wool offers vacuum-formed shapes crafted from high-quality ceramic fibers, designed to meet the most demanding industrial applications. These shapes provide excellent thermal insulation, mechanical strength, and dimensional stability, even under extreme conditions.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="rs-about-wrapper">
                            <div class="rs-about-content-wrapper">
                              ...
                              Key Highlights
                                    ...
                                    <h2 class="rs-section-title rs-split-text-enable split-in-fade">Engineered for performance and flexibility.</h2>
                                </div>
                                <div class="rs-aobut-tab-content-wrapper">
                                    <div class="tab-content rs-about-tab-anim" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-item-one" role="tabpanel" aria-labelledby="pills-item-one-tab" tabindex="0">
                                            <div class="rs-about-tab-content">
                                                <p>Our vacuum-formed shapes are available in standard and custom forms, ensuring precise fit and reliable performance. With strong thermal and chemical resistance, they extend equipment life while improving efficiency.</p>
                                                <div class="rs-about-feature-list">
                                                    <div class="rs-list-item has-theme-orange">
                                                        <ul>
                                                            <li>
                                                                <i class="fa-regular fa-check"></i>Available in boards, cones, and custom designs
                                                            </li>
                                                            <li>
                                                                <i class="fa-regular fa-check"></i>Excellent thermal & chemical resistance
                                                            </li>
                                                            <li>
                                                                <i class="fa-regular fa-check"></i>High strength with lightweight structure
                                                            </li>
                                                            <li>
                                                                <i class="fa-regular fa-check"></i>Consistent quality with reliable performance
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                            ...
                            <div class="rs-about-thumb-wrapper">
                                ...
                                <div class="rs-about-thumb">
                                    <img src="assets/images/service/Vacuum-formed/Vacuum-formed-shapes-2.jpg" alt="image" >
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-5">
                        <div class="rs-about-thumb-wrapper">
                            ...
                            <div class="rs-about-thumb img-one">
                                <img src="assets/images/service/Vacuum-formed/Vacuum-formed-shapes-1.jpg" alt="image">
                            </div>
                            <div class="rs-about-thumb img-two">
                                <img src="assets/images/service/Vacuum-formed/Vacuum-formed-shapes.jpg" alt="image">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="rs-about-content-wrapper">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" width="11" height="15" viewBox="0 0 11 15"
                               ...
                               Industries We Serve
                                    ...
                                    <h2 class="rs-section-title has-theme-green rs-split-text-enable split-in-fade">Trusted insulation for multiple sectors.</h2>
                                    <p class="descrip">Vacuum-formed shapes from Apple Cera Wool are widely used in industries where precision and durability are essential. They support efficient operations while reducing maintenance and energy costs.</p>
                                </div>
                                <div class="rs-about-feature-list">
